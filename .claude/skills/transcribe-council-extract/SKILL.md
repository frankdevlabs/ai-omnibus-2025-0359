...
5. Read the matching **reference version's** files to mirror structure,
   `<a id="...">` anchors and header style: the `extracts/commission/COM-2025-836_*`
   baseline set, the agreed-text `extracts/agreed/PE-789081_*` set, or — for a
   Council compromise — any previous `extracts/council/ST-<nnnn>-<yyyy>_*` set
   (one file per `tracker.yaml` `extract_slices`).
